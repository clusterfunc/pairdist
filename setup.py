...
PACKAGENAME = metadata.get('package_name', 'pairdist')
DESCRIPTION = metadata.get('description', 'Pairwise distances')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: pairdist requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
